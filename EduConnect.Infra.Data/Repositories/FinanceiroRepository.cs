...
public class FinanceiroRepository(EduContext context) : IFinanceiroRepository
{
    ...
    public async Task<(List<Financeiro>, int TotalRegistro)> GetByFilters(FiltroFinanceiro filtro)
    {
    ...
    {
        return await _context.Financeiros.FirstOrDefaultAsync(dados => dados.Registro == Registro && dados.Deletado == false) ?? null;
    }

    public async Task<bool> Add(Financeiro financeiro)
    {
    ...
    public async Task<bool> Update(Financeiro financeiro)
    {
    ...
    public async Task<bool> Delete(Financeiro financeiro)
    {
